               ...
               <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="col-md-6 col-xs-12">
                     <div class="intern-block border-blue">
                        <img src="https://res.cloudinary.com/taiwodave/image/upload/v1554472059/t.png" alt="Mark Essien">
                        <h6>Akindele Taiwo	</h6>
                  ...
                  <div class="col-md-6 col-xs-12 align-items-center">
                     <div class="intern-bio border-blue">
                        <h6>About me</h6>
                        <p>Am a Fullstack developer with 3 years experience using php and laravel as a framework.  </p>
                        <br />
                        <h6>Skills</h6>
                        <p>JavaScript | PHP | VB.net</p>
                     </div>
                  </div>
               </div>
            </div>
